...
echo "[SGX-SOFTWARE-ENABLE] Downloading sgx-software-enable..."
...
echo "[SGX-SOFTWARE-ENABLE] Building sgx-software-enable..."
make -s -C sgx-software-enable

# Enable the Intel(R) SGX via the Intel(R) SGX Software Enabling Application
echo "[SGX-SOFTWARE-ENABLE] Installing sgx-software-enable..."
