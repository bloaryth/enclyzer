...
int fn_taa_st_nosgx(char *extra_settings) {
  // SET CPU AFFINITY
  int core = 1;
  cpu_set_t cpuset;
  CPU_ZERO(&cpuset);
...
#pragma region taa_st_sgx

int fn_taa_st_sgx(char *extra_settings) {
  // SET CPU AFFINITY
  int core = 1;
  cpu_set_t cpuset;
  CPU_ZERO(&cpuset);
...
#pragma region taa_ct_nosgx

void *victhrd_taa_ct_nosgx(void *arg) {
...
void *attthrd_taa_ct_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
int fn_taa_ct_nosgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(
        !pthread_create(&adversary_thread, NULL, attthrd_taa_ct_nosgx, NULL));
...
#pragma region taa_ct_sgx

void *victhrd_taa_ct_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
void *attthrd_taa_ct_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
#pragma region taa_cc_nosgx

void *victhrd_taa_cc_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
void *attthrd_taa_cc_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
int fn_taa_cc_nosgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(
        !pthread_create(&adversary_thread, NULL, attthrd_taa_cc_nosgx, NULL));
...
#pragma region taa_cc_sgx

void *victhrd_taa_cc_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
...
void *attthrd_taa_cc_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNSED PARAMETER
  (void)arg;
