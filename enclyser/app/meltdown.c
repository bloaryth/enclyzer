...
int fn_meltdown_st_nosgx(char *extra_settings) {
  // SET CPU AFFINITY
  int core = 1;
  cpu_set_t cpuset;
  CPU_ZERO(&cpuset);
...
Test(meltdown, meltdown_st_nosgx, .disabled = false) {
  ...
  filling_buffer->access_ctrl = BUFFER_ACCESS_CTRL_SUPERVISOR;
...
#pragma region meltdown_st_sgx

int fn_meltdown_st_sgx(char *extra_settings) {
  // SET CPU AFFINITY
  int core = 1;
  cpu_set_t cpuset;
  CPU_ZERO(&cpuset);
...
#pragma region meltdown_ct_nosgx

void *victhrd_meltdown_ct_nosgx(void *arg) {
...
void *attthrd_meltdown_ct_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
int fn_meltdown_ct_nosgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(!pthread_create(&adversary_thread, NULL, attthrd_meltdown_ct_nosgx,
                           NULL));
...
#pragma region meltdown_ct_sgx

void *victhrd_meltdown_ct_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
void *attthrd_meltdown_ct_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
int fn_meltdown_ct_sgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(!pthread_create(&adversary_thread, NULL, attthrd_meltdown_ct_sgx,
                           NULL));
...
#pragma region meltdown_cc_nosgx

void *victhrd_meltdown_cc_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
void *attthrd_meltdown_cc_nosgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
int fn_meltdown_cc_nosgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(!pthread_create(&adversary_thread, NULL, attthrd_meltdown_cc_nosgx,
                           NULL));
...
#pragma region meltdown_cc_sgx

void *victhrd_meltdown_cc_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
void *attthrd_meltdown_cc_sgx(void *arg) {
  // BYPASS THE WARNING ABOUT UNUSED PARAMETER
  (void)arg;
...
int fn_meltdown_cc_sgx(char *extra_settings) {
  ...
  for (int offset = 0; offset < CACHELINE_SIZE; offset++) {
    ...
    ASSERT(!pthread_create(&adversary_thread, NULL, attthrd_meltdown_cc_sgx,
                           NULL));
