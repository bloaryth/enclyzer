#ifndef enclyzer_LIBenclyzer_DEF

#define enclyzer_LIBenclyzer_DEF
...
} enclyzer_ia32_arch_capabilities_msr;
...
typedef struct
{
    ...
    enclyzer_ia32_spec_ctrl_msr ia32_spec_ctrl_msr;                 /** RDMSR.(ECX=0x48):EAX */
    enclyzer_ia32_arch_capabilities_msr ia32_arch_capabilities_msr; /** RDMSR.(ECX=0x10a):EAX */
    enclyzer_tsx_force_abort_msr tsx_force_abort_msr;               /** RDMSR.(ECX=0x10f):EAX */
    enclyzer_ia32_tsx_ctrl_msr ia32_tsx_ctrl_msr;                   /** RDMSR.(ECX=0x122):EAX */
    enclyzer_ia32_mcu_opt_ctrl_msr ia32_mcu_opt_ctrl_msr;           /** RDMSR.(ECX=0x123):EAX */
 ...
 *
 * TODO Automatically getting these data in enclyzer/libenclyzer/system.h
 *
 */
